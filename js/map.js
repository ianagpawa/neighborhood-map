...
function initMap() {
    ...
    function singleMarker(restaurant){
        ...
        var contentString = "<div class='text-center' id='content><h1 id='restaurant_name' class='firstHeading'>%RestaurantName%</h1><div id='restaurant_info'><p>%ADDRESS%</p></div></div>";
